import { Calendar, Github, Moon, Sparkles } from "lucide-react";
  ...
  const projetos = [
    {
      ...
      link: "https://github.com/luisrossim/eletron",
      year: "2024 - 2025",
      description: `Sistema de gestão de uma eletrônica. Reformulação do projeto "Eletrônica V1".`,
      features: [
          { name: "Login", detail: "ngx-cookies, JWT" },
          { name: "User Roles" },
    ...
    {
      id: 5,
      title: "Eletrônica V1 (Java Vanilla + Hibernate)",
      link: "https://github.com/luisrossim/eletronica-java",
      year: "2023",
      ...
      {projetos.map((projeto) => (
        <div key={projeto.id} id={`card-projeto-${projeto.id}`} className="p-6 border rounded-lg mb-6">
          <div className="flex items-center gap-4 mb-3">
            ...
            <h2 className="text-2xl xl:text-3xl font-semibold">{projeto.title}</h2>
          </div>
          ...
          {/* Imagens */}
          <div className="col-span-2 mt-6 px-12">
            <Carousel>
              <CarouselContent>
