		...
		<div className="max-w-[1280px] mx-auto px-4 lg:px-6">
			<div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
				<div className="flex flex-col gap-5 pt-28 pb-12 lg:pb-28">
					<h2 className="text-slate-600 font-medium text-sm">{profile.area}</h2>
					<h1 className="text-4xl lg:text-5xl font-bold">{profile.nome}</h1>
					<p className="text-slate-500 md:w-2/3">
				...
				<div
					...
					className="relative h-[200px] lg:h-[420px] w-full brightness-75"
				>
